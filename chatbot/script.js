...
const userMessage = [
  ...
  /* 8 */["developer number", "message", "You are bad", "contact developer", "report", "there is bug", "bug", "who's behind you", "contact", "phone", "contact", "info", "whatsapp", "wa", "number", "Who is Saptarshi", "Saptarshi", "Saptarshi bg", "bg", "Bhagat"],
...
const botReply = [
  ...
  /* 6 */["Saptarshi Mahapatra is my creator 🙌"],
  
  /* 11 */["I am SAD AI by Saptarshi Mahapatra 😊"],
  /* 12 */["I love you too ❤️", "Me too! 😄", "Thanks! Try giving feedback on WhatsApp: <a href='https://wa.me/9994442255'>9994442255</a> 💬"],
  /* 13 */[
    "I'm glad to hear that you're feeling happy! 😄", "That's great! 😊", "Thanks! Try giving feedback on WhatsApp: <a href='https://wa.me/9994442255'>9994442255</a> 💬", "Fun is always good! 🎉", "Wonderful! 😄", "Fantastic! 😃", "Cool! 😎", "😊", "Awesome! 🌟", "Excellent! 👏"
  ],
  /* 14 */[
  ...
  /* 17 */["That's a secret only Saptarshi knows! 🤫"],
...
const alternative = [
  ...
  "You can contact Saptarshi:<br> Phone: <a href='tel:9967325655'>9967325655 📱</a><br> WhatsApp: <a href='https://wa.me/9967325655'>9967325655 💬"
];
let lastUserDiv;
